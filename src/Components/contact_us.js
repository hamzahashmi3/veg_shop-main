                ...
                <div className="row">
                    ...
                    <div className="col-lg-3 col-md-3 col-sm-6 text-center">
                        <div className="contact__widget">
                            ...
                            <h4>Email</h4>
                            <p>
                                <Link href="https://preview.colorlib.com/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="563e333a3a391635393a39243a3f347835393b">[email&#160;protected]</Link>
                            </p>
                        </div>
                    </div>
                </div>
